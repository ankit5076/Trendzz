...
import com.trends.trending.utils.AppCompatPreferenceActivity;
...
//            get switch preference value
//            SwitchPreference videoPref = (SwitchPreference) findPreference(getString(R.string.notifications_video_message));
//            videoPref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
//                @Override
//                public boolean onPreferenceChange(Preference preference, Object o) {
//                    SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(getActivity());
//
//                    Log.d("videooopref", sharedPreferences.getBoolean((getString(R.string.notifications_video_message)), true)+"");
////                    Log.d("videooopref1", videoPref.getKey());
//                    return true;
//                }
//            });
